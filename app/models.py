...
class Car(db.Model):
    ...
    def __init__(self, make, model, year, mileage, user_token, id = ''):
        self.id = self.set_id()
        self.make = make
        self.model = model
        self.year = year
    ...
    def __repr__(self):
        return f'The following car has been added to the user\'s inventory: {self.make} {self.model}'
...
class CarSchema(ma.Schema):
    class Meta:
        fields = ['id', 'make', 'model', 'year', 'mileage']
